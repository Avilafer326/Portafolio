...
/**
 * Links de redes sociales (GitHub, LinkedIn, Email).
 * Usa `dark:` para alternar color de icono entre modos.
 */
@Component({
  ...
  template: `
    <div class="flex items-center gap-4">
      <a
        ...
        class="text-text-muted dark:text-text-muted-dark hover:text-accent-purple transition-colors"
        aria-label="GitHub"
      >
      ...
      <a
        href="mailto:hola@fernandoavila.dev"
        class="text-text-muted dark:text-text-muted-dark hover:text-accent-purple transition-colors"
        aria-label="Email"
      >
